...
Windows uses deterministic A2A transport persistence for protocol files. Never request a Windows model tool call for file persistence. Never say a file was saved without TRANSPORT_PERSISTENCE_RECEIPT. Never use DefraDB.
